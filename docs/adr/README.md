...
| [0004](0004-rln-over-slot-scheme.md) | Real RLN over the public-slot scheme | Chose real circom-rln Groth16 (fresh per-request share, over-spend reconstructs the secret and slashes) over the ROADMAP #1 public-slot scheme, which was simpler but leaked the slot histogram and had no slashing. |
