...
// (ports, region, proto, artifacts). TOTAL: never throws; unknown/invalid fields are dropped;
...
export function hasCaps(caps) {
  ...
  return c.ports !== undefined || c.region !== undefined || c.proto !== undefined || c.artifacts !== undefined;
}
