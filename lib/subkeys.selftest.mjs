...
function main() {
  ...
  //   index   = 0
  const GOLDEN_SECRET =
    "15287101327429642807105986357603366092454726333870963172897119265896784737254";
  const GOLDEN_COMMITMENT =
    "17604242549998308958327004971887250769036516467459452841581158818479898941271";
