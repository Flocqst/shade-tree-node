...
//
// The Rust `shade-tree egress` (rust/shade-tree-client, `--features live`) does not derive an identity from
...
// Rust interop harness (rust/shade-tree-rln/interop/egress-derive.mjs). They MUST agree byte-for-byte,
